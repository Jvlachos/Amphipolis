...
public class Digger extends Character implements Serializable {
    private final String skill_desc="Take up to 2 tiles from the sorting area you chose earlier in your turn";
    private JPanel previous_choice;
    private int tiles_taken;
    private boolean skill_complete;
    public Digger(String type,Player owner) {
        super(type,owner);
    ...
    public void Character_Skill(GUI gui, ActionEvent event) {
        ...
        if(tiles_taken<2 && previous_choice==parent && !skill_complete) {
            ...
            JOptionPane optionPane = new JOptionPane("You are allowed to take 2 tiles from the sorting area you chose earlier", JOptionPane.ERROR_MESSAGE);
